...
NEXUS_PRODUCTS = [
    ...
    },
    {
        ...
        "tagline": "Conversational flight search, PNR tracking & booking bot",
        "url": "https://whatsapp-flight-addon.vercel.app",
        "price_mur": 25000,
        "price_usd": 550,
        "target_audience": ["airlines", "travel agencies", "DMCs", "frequent flyers", "aviation enthusiasts"],
        "hashtags": ["#AviationAI", "#FlightAddon", "#WhatsAppBot", "#TravelTech", "#MauritiusTravel"],
    },
    {
        "id": "whatsapp_restaurant_sme",
        "name": "WhatsApp Restaurant & SME Booking",
        "tagline": "24/7 automated table reservations, daily menus & takeaway ordering with Juice clearing",
        "url": "https://whatsapp-flight-addon.vercel.app",
        "price_mur": 15000,
        "price_usd": 350,
        "target_audience": ["restaurants", "cafes", "bistros", "spas", "retail shops", "hospitality"],
        "hashtags": ["#RestaurantTech", "#WhatsAppCommerce", "#MauritiusFood", "#LocalBusiness", "#JuicePayment"],
    },
    {
        "id": "nexus_license",
